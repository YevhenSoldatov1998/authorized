...
import {FORGOT_PATH} from "../../../../neko-1-main/m-1-ui/Routes";
...
const SignIn: FC<Props & MapDispatchToPropsType> = (
    {
        ...
        signInThunk, signInEmailChange, signInPasswordChange, signInRememberMeChange
    }
) => {
    const handleSignIn = () => {
    ...
    return (
        <div>
            <div className="form">
                ...
                <br/>
                <button disabled={isLoading} onClick={handleSignIn}>Sign in</button>
            </div>
